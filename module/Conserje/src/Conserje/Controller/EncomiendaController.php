...

    {
        ...
        for($i=0;$i<count($lst);$i++){
            ...
            $info=$info." <tr><td>".$lst[$i]['dpto']."</td>
                              ...
                              <td><a href='#' class='imgth' data='".$fichero."'>".$lst[$i]['foto_corto']."</a></td>
        ...
        return new ViewModel(array('info'=>$info,'rsptaOK'=>SysFnc::rspOK(),'nuevaPersona'=>SysFnc::nuevaPersona(),'imgView'=>SysFnc::cargarVistaImagen()));
    }
