...
use Sistema\Model\Entity\AsuntoTable;
use Sistema\Model\Entity\DestinatarioTable;
...
class ComunicacionController extends AbstractActionController {
    ...
    public function nuevoreclamoAction() {
        ...
        $form->get('id_asunto')->setAttribute('options', $Ast->GetAsuntoReclamo());
        $form->get('id_reseptor')->setAttribute('options', $Destinatario->GetDestinatarioReclamo());
        $form->get('id_unidad')->setAttribute('value', $sid->id_unidad);
        $form->get('id_usuario')->setAttribute('value', $sid->id_usuario);
    // if ($data['mensaje']!=""){
    ...
    if (!isset($_POST) || !empty($_POST) ) {
           ...
           $desc ="Su ".$data->ReclamoSugerencia." Fue exitozamente guadada";
        //Retornamos a la vista        
